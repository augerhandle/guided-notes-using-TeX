...
\begin{myObjectives}
    \myObjective{solve}{rational equations}
\end{myObjectives}    

\begin{myVocabulary}
    \myDefinition{rational expression}{a \gap{fraction} of polynomials}
    \myDefinition{rational equation}{an equation containing rational expressions}
    \myDefinition{extraneous solution}{an \gap{fake} solution, a solution that does {\bfseries\itshape not} work}
\end{myVocabulary}
