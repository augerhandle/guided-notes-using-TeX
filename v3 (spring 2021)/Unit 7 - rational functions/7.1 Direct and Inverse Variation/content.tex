...
\myLesson{Direct and Inverse Variation}[1]

\begin{myObjectives}
    \myObjective{write}{equations representing direct and inverse variation}
    \myObjective{distinguish}{between direct and inverse variation (based on data)}
\end{myObjectives}
