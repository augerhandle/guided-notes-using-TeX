\newcommand{\myHeadFootStyle}{\tiny\sffamily\itshape}
...
% \myLesson to print it out, and that seems to work fine.
%
...
\makeoddfoot{myPagestyle}
    ...
    {\myHeadFootStyle\myFullLessonNumber\,\,\myCurrentLessonTitle}
