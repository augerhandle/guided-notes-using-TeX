...
\NewDocumentCommand{\myAndInterval}{O{\myIntervalScale} m O{#2}}{
    ...
    \begin{tikzpicture}[scale=#1]
        ...
        % the labels
        \node[circle,inner sep=0.3em,draw=black,fill=#2,line width=0.7mm,label=below:{$L$}] at (3,0) {};
        \node[circle,inner sep=0.3em,draw=black,fill=#3,line width=0.7mm,label=below:{$R$}] at (7,0) {};
    \end{tikzpicture}
}
