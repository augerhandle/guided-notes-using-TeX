...
% ---------------------CONCEPT 2------------------------------
\begin{myKeyConcepts}[To determine if a relation consisting of a set of points is a function\dots]
    Follow these steps:
    \setlist{labelindent=\parindent,}
    \begin{enumerate}
        \item {\bfseries\itshape Write down} all the inputs ($x$ values).
...
% ---------------------CONCEPT 3------------------------------
\begin{myKeyConcepts}[To determine if a relation represented as the graph is a function\dots]
    Follow these steps:
    \setlist{labelindent=\parindent,}
    \begin{enumerate}
