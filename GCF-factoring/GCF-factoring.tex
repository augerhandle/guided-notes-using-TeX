...
\dashundergapssetup{
    ...
    gap-font=\scshape\sffamily,
    gap-numbers=true,
    gap-widen=true,
    gap-extend-percent=200,
...
% If there's "extra" vertical space on this page, put it all at the bottom.
\raggedbottom
...
\begin{myKeyConcepts}[To factor a monomial into its ``prime'' factors\dots]
    ...
    \item Write each variable (letter) down a number of times equal to its \myFillInBlank{exponent}.
    \end{enumerate}
\end{myKeyConcepts}
