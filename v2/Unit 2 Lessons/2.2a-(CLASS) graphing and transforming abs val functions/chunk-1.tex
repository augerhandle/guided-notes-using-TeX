...
\end{itemize}
%
The absolute value \gap{parent function} 
...
\begin{center}
    \begin{tcolorbox}[width=5in]
        The graph of the absolute value parent function looks like a letter \gap{V}.
        \vskip1em
...
\begin{myConceptSteps}{To sketch the graph of the absolute value parent function\dots}
    \myStep{vertex}{Draw a dot at the \gap{origin}. This is the \gap{vertex}.}
    \myStep{right branch}{
        From the vertex, draw a line \gap{up 1} and \gap{right 1}. 
    }
    \myStep{left branch}{
        From the vertex, draw a line \gap{up 1} and \gap{left 1}. 
    }
\end{myConceptSteps}
