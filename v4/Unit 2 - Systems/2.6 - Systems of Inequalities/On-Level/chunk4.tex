  ...
  whose solution is shown in this graph.]
{
  \begin{myTikzpictureGrid}{0.75} [-6]{5}{5} [dotted]
    ...
    \tkzDrawAreafg[between= b and d,color=black!85,domain = -5:-1]
    \tkzDrawAreafg[between= b and a,color=black!85,domain = -1:0]
    \tkzDrawAreafg[between= c and a,color=black!85,domain = 0:4]
